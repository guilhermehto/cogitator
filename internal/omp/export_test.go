...
// ReadSessionsForTest re-exports ReadSessions so external test packages can call
// it without importing the internal package directly.
var ReadSessionsForTest = ReadSessions

// HandleHookFrameForTest exposes handleHookFrame for deterministic testing.
